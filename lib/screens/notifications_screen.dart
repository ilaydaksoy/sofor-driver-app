...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  final List<Map<String, dynamic>> notifications = [
    ...
    },
    {
      ...
      'message': 'Fatma Özkan ile yaptığınız seyahat başarıyla tamamlandı.',
      'time': '3 saat önce',
      'isRead': true,
    ...
    },
    {
      ...
      'type': 'Duyuru',
      'title': 'Yeni Özellik',
      'message': 'Artık günlük seyahat raporlarınızı görüntüleyebilirsiniz.',
      'time': '1 gün önce',
      'isRead': true,
    ...
    },
    {
      ...
      'message': 'Bu haftaki seyahat bilgileriniz güncellendi.',
      'time': '2 gün önce',
      'isRead': true,
      'icon': Icons.update,
      'color': Colors.green,
